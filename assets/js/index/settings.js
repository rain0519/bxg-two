...
require(['/two/assets/js/config.js'],function(){
    ...
    '/two/assets/js/common.js'
        ...
        var options = {
            ...
            success:function(data){
                if(data.code==200){
                    //渲染页面
                    var result = template('telm',{list:data.result});
                    $('.settings').html(result);
                    tcID = data.result.tc_id;
                    console.log(tcID);

                    //页面上的功能
                    $('.settings').on('change','#upfile',function(){//监听文件上传事件
                            nativeUploader();            
                    }) //1-上传头像 

                    PCD2();//2-省市三级联动
                    datePickerInit()//3-日期插件初始化
                    validateInit()//4-表单验证初始化
        ...
        function PCD2(){
            ...
            function cityChange(){
                getOptions($city.val(),$district,'d')
            }
 ...
 //2-1省市三级联动——模板引擎
        ...
        //     function cityChange(){
        //         var select = $city.val();
        //         var cityObj = pcd.d[select];
        //        // console.log(select);
        //         var str = '';
        //         for(var key in cityObj){
        //             str += `<option value="${key}">${cityObj[key]}</option>`;
        //         }
        //         $district.html(str);
        //     }
        // }
